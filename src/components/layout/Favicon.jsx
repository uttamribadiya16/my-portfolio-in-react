...
const createFavicon = (color) => {
  ...
  `;
    // <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path d="M6 12l5-5 5 5M6 12l5 5 5-5" stroke="${color}" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
...
export function Favicon() {
  ...
  useEffect(() => {
    // Create dynamic favicon based on theme's accent color
    const favicon = createFavicon(currentTheme.colors.accent);
